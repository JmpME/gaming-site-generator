...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientId'] = 4720;
        $headers['auth']['clientCompany'] = "vmfaid7C1yYJNya30c8c";
        $headers['auth']['clientSecret'] = "NDcyMHZtZmFpZDdDMXlZSk55YTMwYzhjY2U2NmY2ZTZmOWRlZjUxMGFjNDBiYTJlNjVjMmFjZGEwMTQyZmZhZQ==";
